...
Same motion as the first variation of ["noodles"](./noodles#variation-1), which
is shown below, but use the "K" hand sign on the left hand, and the "T" hand
...
is shown below, then pretend to use 2 spatulas to toss food in a wok.
